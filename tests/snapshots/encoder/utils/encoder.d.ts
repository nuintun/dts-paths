...
export declare function injectECCodewords(
  bits: BitArray,
  { ecBlocks, numECCodewordsPerBlock }: ECBlocks
): BitArray;
...
export declare function appendECI(
  bits: BitArray,
  segment: Segment,
  currentECIValue: number
): number;
...
export declare function appendLengthInfo(
  bits: BitArray,
  mode: Mode,
  version: Version,
  numLetters: number
...
export declare function calculateBitsNeeded(
  segmentBlocks: SegmentBlock[],
  version: Version
): number;
export declare function chooseRecommendVersion(
  segmentBlocks: SegmentBlock[],
  ecLevel: ECLevel
): Version;
